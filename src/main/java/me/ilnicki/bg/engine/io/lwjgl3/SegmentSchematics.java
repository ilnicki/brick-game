...
//TODO: Make non-static, move to config.
public class SegmentSchematics {
    private final static HashMap<Character, boolean[]> schematics = new HashMap<>();

    static {
        schematics.put(null, new boolean[]{false, false, false, false, false, false, false});
        // @formatter:off
    ...
    public static boolean[] getSchematic(Character chr) {
        boolean[] schematic = schematics.get(chr);
        return schematic != null ? schematic : schematics.get(null);
    }
