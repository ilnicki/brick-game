...
class SegmentSchematics {
  ...
  SegmentSchematics() {
    schematics.put(
        null, nullChar = new boolean[] {false, false, false, false, false, false, false});
    ...
    schematics.put(
        'I', new boolean[] {false, true, true, false, false, false, false, false, false});
    ...
    schematics.put(
        'M', new boolean[] {false, false, false, false, false, false, false, false, false});
    ...
    schematics.put(
        'W', new boolean[] {false, false, false, false, false, false, false, false, false});
    schematics.put(
        'X', new boolean[] {false, false, false, false, false, false, false, false, false});
    schematics.put('Y', new boolean[] {false, true, true, false, false, false, false, true, false});
    schematics.put(
        'Z', new boolean[] {false, false, false, false, false, false, false, false, false});
    schematics.put(
